...
public final class CefTestLifecycle {
     ...
     * boundary. Newer CEF releases exercise the explicit shutdown path, while the old-release matrix continues to
     * exercise deterministic browser teardown without turning an upstream process-exit fault into a false test failure.
     */
