 ...
 * Companion to {@code BrowserBackendSmokeTest} in {@code cef4j-ipc-frame-mmap}; both demonstrate that test code can be
 * written once and parameterised over the discovered backend list.
 *
