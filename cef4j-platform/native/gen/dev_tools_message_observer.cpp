...
struct JniCefDevToolsMessageObserver : public cef_dev_tools_message_observer_t {
    ...
    JniCefDevToolsMessageObserver(JavaVM* vm, jobject handler) : cef_dev_tools_message_observer_t{}, jvm(vm) {
        javaHandler = handler;
        InitRefCount<JniCefDevToolsMessageObserver, cef_dev_tools_message_observer_t>(reinterpret_cast<cef_base_ref_counted_t*>(static_cast<cef_dev_tools_message_observer_t*>(this)));
