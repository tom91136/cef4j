...
struct JniCefLifeSpanHandler : public cef_life_span_handler_t {
    ...
    : nullptr;
        ...
        if (windowInfo && j_windowInfo) {
            (windowInfo)->ex_style = static_cast<decltype((windowInfo)->ex_style)>(env->GetIntField(j_windowInfo, env->GetFieldID(j_windowInfo_cls, "exStyle", "I")));
            ...
            (windowInfo)->style = static_cast<decltype((windowInfo)->style)>(env->GetIntField(j_windowInfo, env->GetFieldID(j_windowInfo_cls, "style", "I")));
