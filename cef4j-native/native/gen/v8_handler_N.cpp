...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefV8Handler), release0)(JNIEnv* env, jclass clz, jlong ptr) {
    auto* b = reinterpret_cast<cef_base_ref_counted_t*>(ptr);
    if (b) b->release(b);
}

CEF4J_JNI_EXPORT(jboolean, CEF4J_PEER(CefV8Handler), execute0)(JNIEnv* env, jobject obj, jlong self, jstring name, jobject object, jlong argumentsCount, jobjectArray arguments, jobject retval, jstring exception) {
