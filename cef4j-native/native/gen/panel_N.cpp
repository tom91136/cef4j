...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), release0)(JNIEnv* env, jclass clz, jlong ptr) {
    auto* b = reinterpret_cast<cef_base_ref_counted_t*>(ptr);
    if (b) b->release(b);
}

CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefPanel), asWindow0)(JNIEnv* env, jobject obj, jlong self) {
...
CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefPanel), setToFillLayout0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return nullptr;
...
CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefPanel), setToBoxLayout0)(JNIEnv* env, jobject obj, jlong self, jobject settings) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return nullptr;
...
CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefPanel), getLayout0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return nullptr;
    auto _r = s->get_layout(s);
    if (!_r) return nullptr;
    auto _rCls = env->FindClass("net/kurobako/cef4j/gen/CefLayout$NativePeer");
    auto _rCtor = env->GetMethodID(_rCls, "<init>", "(J)V");
    return env->NewObject(_rCls, _rCtor, reinterpret_cast<jlong>(_r));
}

CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), layout0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
    s->layout(s);
}

CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), addChildView0)(JNIEnv* env, jobject obj, jlong self, jobject view) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), addChildViewAt0)(JNIEnv* env, jobject obj, jlong self, jobject view, jint index) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
    cef_view_t* _view_ptr = view ? reinterpret_cast<cef_view_t*>(env->GetLongField(view, env->GetFieldID(env->GetObjectClass(view), "nativePtr", "J"))) : nullptr;
    if (_view_ptr) {auto* _b = reinterpret_cast<cef_base_ref_counted_t*>(_view_ptr); _b->add_ref(_b);}
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), reorderChildView0)(JNIEnv* env, jobject obj, jlong self, jobject view, jint index) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
    cef_view_t* _view_ptr = view ? reinterpret_cast<cef_view_t*>(env->GetLongField(view, env->GetFieldID(env->GetObjectClass(view), "nativePtr", "J"))) : nullptr;
    if (_view_ptr) {auto* _b = reinterpret_cast<cef_base_ref_counted_t*>(_view_ptr); _b->add_ref(_b);}
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), removeChildView0)(JNIEnv* env, jobject obj, jlong self, jobject view) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
    cef_view_t* _view_ptr = view ? reinterpret_cast<cef_view_t*>(env->GetLongField(view, env->GetFieldID(env->GetObjectClass(view), "nativePtr", "J"))) : nullptr;
    if (_view_ptr) {auto* _b = reinterpret_cast<cef_base_ref_counted_t*>(_view_ptr); _b->add_ref(_b);}
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefPanel), removeAllChildViews0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return;
    s->remove_all_child_views(s);
}

CEF4J_JNI_EXPORT(jlong, CEF4J_PEER(CefPanel), getChildViewCount0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_panel_t*>(self);
    if (!s) return 0;
    return static_cast<jlong>(s->get_child_view_count(s));
}

CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefPanel), create0)(JNIEnv* env, jclass clz, jobject delegate) {
