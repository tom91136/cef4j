...
// JNI wrapper struct for cef_component_update_callback_t
...
extern "C" JNIEXPORT jlong JNICALL Java_net_kurobako_cef4j_gen_CefComponentUpdateCallback_1N_N_1Create(JNIEnv* env, jobject obj) {
    return reinterpret_cast<jlong>(Create_JniCefComponentUpdateCallback(env, obj));
}
