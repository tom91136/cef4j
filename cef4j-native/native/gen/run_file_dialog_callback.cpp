...
// JNI wrapper struct for cef_run_file_dialog_callback_t
...
extern "C" JNIEXPORT jlong JNICALL Java_net_kurobako_cef4j_gen_CefRunFileDialogCallback_1N_N_1Create(JNIEnv* env, jobject obj) {
    return reinterpret_cast<jlong>(Create_JniCefRunFileDialogCallback(env, obj));
}
