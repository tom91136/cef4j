...
CEF4J_JNI_EXPORT(jlong, CEF4J_PEER(CefBrowserHost), getOpenerWindowHandle0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return 0;
    return to_jlong(s->get_opener_window_handle(s));
}
...
CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefBrowserHost), getClient0)(JNIEnv* env, jobject obj, jlong self) {
    ...
    if (!_r) return nullptr;
    auto _rCls = FindClassCached(env, "net/kurobako/cef4j/gen/CefClient$NativePeer");
    auto _rCtor = env->GetMethodID(_rCls, "<init>", "(J)V");
    return env->NewObject(_rCls, _rCtor, reinterpret_cast<jlong>(_r));
}
...
CEF4J_JNI_EXPORT(jboolean, CEF4J_PEER(CefBrowserHost), canZoom0)(JNIEnv* env, jobject obj, jlong self, jobject command) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return JNI_FALSE;
    if (!command) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "command must not be null"); return JNI_FALSE; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), zoom0)(JNIEnv* env, jobject obj, jlong self, jobject command) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!command) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "command must not be null"); return; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), printToPdf0)(JNIEnv* env, jobject obj, jlong self, jstring path, jobject settings, jobject callback) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!settings) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "settings must not be null"); return; }
    auto _path_str = JStringToCefString(env, path);
    cef_pdf_print_settings_t _settings_val = {};
    auto _settings_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefPdfPrintSettings");
    _settings_val.landscape = static_cast<decltype(_settings_val.landscape)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "landscape", "I")));
    _settings_val.print_background = static_cast<decltype(_settings_val.print_background)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "printBackground", "I")));
    _settings_val.scale = static_cast<decltype(_settings_val.scale)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "scale", "D")));
    _settings_val.paper_width = static_cast<decltype(_settings_val.paper_width)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "paperWidth", "D")));
    _settings_val.paper_height = static_cast<decltype(_settings_val.paper_height)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "paperHeight", "D")));
    _settings_val.prefer_css_page_size = static_cast<decltype(_settings_val.prefer_css_page_size)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "preferCssPageSize", "I")));
    auto _rd_margin_type = env->GetObjectField(settings, env->GetFieldID(_settings_c, "marginType", "Lnet/kurobako/cef4j/gen/CefPdfPrintMarginType;"));
    if (_rd_margin_type) {
    ...
    _settings_val.margin_top = static_cast<decltype(_settings_val.margin_top)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "marginTop", "D")));
    _settings_val.margin_right = static_cast<decltype(_settings_val.margin_right)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "marginRight", "D")));
    _settings_val.margin_bottom = static_cast<decltype(_settings_val.margin_bottom)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "marginBottom", "D")));
    _settings_val.margin_left = static_cast<decltype(_settings_val.margin_left)>(env->GetDoubleField(settings, env->GetFieldID(_settings_c, "marginLeft", "D")));
    jstring _rd_page_ranges = (jstring)env->GetObjectField(settings, env->GetFieldID(_settings_c, "pageRanges", "Ljava/lang/String;"));
    CefStringSetFromJString(env, _rd_page_ranges, &_settings_val.page_ranges);
    _settings_val.display_header_footer = static_cast<decltype(_settings_val.display_header_footer)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "displayHeaderFooter", "I")));
    jstring _rd_header_template = (jstring)env->GetObjectField(settings, env->GetFieldID(_settings_c, "headerTemplate", "Ljava/lang/String;"));
    CefStringSetFromJString(env, _rd_header_template, &_settings_val.header_template);
    jstring _rd_footer_template = (jstring)env->GetObjectField(settings, env->GetFieldID(_settings_c, "footerTemplate", "Ljava/lang/String;"));
    CefStringSetFromJString(env, _rd_footer_template, &_settings_val.footer_template);
    _settings_val.generate_tagged_pdf = static_cast<decltype(_settings_val.generate_tagged_pdf)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "generateTaggedPdf", "I")));
    _settings_val.generate_document_outline = static_cast<decltype(_settings_val.generate_document_outline)>(env->GetIntField(settings, env->GetFieldID(_settings_c, "generateDocumentOutline", "I")));
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), showDevTools0)(JNIEnv* env, jobject obj, jlong self, jobject windowInfo, jobject client, jobject settings, jobject inspect_element_at) {
    ...
    if (windowInfo) {
        auto _windowInfo_c = FindClassCached(env, "net/kurobako/cef4j/gen/mac/CefWindowInfo");
        ...
        auto _rd_bounds = env->GetObjectField(windowInfo, env->GetFieldID(_windowInfo_c, "bounds", "Lnet/kurobako/cef4j/gen/CefRect;"));
        if (_rd_bounds) {
        ...
        _windowInfo_val.hidden = static_cast<decltype(_windowInfo_val.hidden)>(env->GetIntField(windowInfo, env->GetFieldID(_windowInfo_c, "hidden", "I")));
        _windowInfo_val.parent_view = from_jlong<decltype(_windowInfo_val.parent_view)>(env->GetLongField(windowInfo, env->GetFieldID(_windowInfo_c, "parentView", "J")));
        ...
        _windowInfo_val.view = from_jlong<decltype(_windowInfo_val.view)>(env->GetLongField(windowInfo, env->GetFieldID(_windowInfo_c, "view", "J")));
        auto _rd_runtime_style = env->GetObjectField(windowInfo, env->GetFieldID(_windowInfo_c, "runtimeStyle", "Lnet/kurobako/cef4j/gen/CefRuntimeStyle;"));
    ...
    if (inspect_element_at) {
        auto _inspect_element_at_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefPoint");
        _inspect_element_at_val.x = static_cast<decltype(_inspect_element_at_val.x)>(env->GetIntField(inspect_element_at, env->GetFieldID(_inspect_element_at_c, "x", "I")));
        _inspect_element_at_val.y = static_cast<decltype(_inspect_element_at_val.y)>(env->GetIntField(inspect_element_at, env->GetFieldID(_inspect_element_at_c, "y", "I")));
    }
...
CEF4J_JNI_EXPORT(jboolean, CEF4J_PEER(CefBrowserHost), sendDevToolsMessage0)(JNIEnv* env, jobject obj, jlong self, jobject message) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return JNI_FALSE;
    if (!message) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "message must not be null"); return JNI_FALSE; }
    const void* _message_addr = message ? env->GetDirectBufferAddress(message) : nullptr;
    if (message && !_message_addr) { env->ThrowNew(FindClassCached(env, "java/lang/IllegalArgumentException"), "message must be a direct ByteBuffer; use ByteBuffer.allocateDirect(...)"); return JNI_FALSE; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), invalidate0)(JNIEnv* env, jobject obj, jlong self, jobject type) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!type) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "type must not be null"); return; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), sendKeyEvent0)(JNIEnv* env, jobject obj, jlong self, jobject event) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!event) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "event must not be null"); return; }
    cef_key_event_t _event_val = {};
    auto _event_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefKeyEvent");
    auto _rd_type = env->GetObjectField(event, env->GetFieldID(_event_c, "type", "Lnet/kurobako/cef4j/gen/CefKeyEventType;"));
    if (_rd_type) {
    ...
    _event_val.modifiers = static_cast<decltype(_event_val.modifiers)>(env->GetIntField(event, env->GetFieldID(_event_c, "modifiers", "I")));
    _event_val.windows_key_code = static_cast<decltype(_event_val.windows_key_code)>(env->GetIntField(event, env->GetFieldID(_event_c, "windowsKeyCode", "I")));
    _event_val.native_key_code = static_cast<decltype(_event_val.native_key_code)>(env->GetIntField(event, env->GetFieldID(_event_c, "nativeKeyCode", "I")));
    _event_val.is_system_key = static_cast<decltype(_event_val.is_system_key)>(env->GetIntField(event, env->GetFieldID(_event_c, "isSystemKey", "I")));
    _event_val.character = static_cast<decltype(_event_val.character)>(env->GetCharField(event, env->GetFieldID(_event_c, "character", "C")));
    _event_val.unmodified_character = static_cast<decltype(_event_val.unmodified_character)>(env->GetCharField(event, env->GetFieldID(_event_c, "unmodifiedCharacter", "C")));
    _event_val.focus_on_editable_field = static_cast<decltype(_event_val.focus_on_editable_field)>(env->GetIntField(event, env->GetFieldID(_event_c, "focusOnEditableField", "I")));
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), sendMouseClickEvent0)(JNIEnv* env, jobject obj, jlong self, jobject event, jobject type, jboolean mouseUp, jint clickCount) {
    ...
    auto _event_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefMouseEvent");
    _event_val.x = static_cast<decltype(_event_val.x)>(env->GetIntField(event, env->GetFieldID(_event_c, "x", "I")));
    _event_val.y = static_cast<decltype(_event_val.y)>(env->GetIntField(event, env->GetFieldID(_event_c, "y", "I")));
    _event_val.modifiers = static_cast<decltype(_event_val.modifiers)>(env->GetIntField(event, env->GetFieldID(_event_c, "modifiers", "I")));
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), sendTouchEvent0)(JNIEnv* env, jobject obj, jlong self, jobject event) {
    ...
    auto _event_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefTouchEvent");
    _event_val.id = static_cast<decltype(_event_val.id)>(env->GetIntField(event, env->GetFieldID(_event_c, "id", "I")));
    _event_val.x = static_cast<decltype(_event_val.x)>(env->GetFloatField(event, env->GetFieldID(_event_c, "x", "F")));
    _event_val.y = static_cast<decltype(_event_val.y)>(env->GetFloatField(event, env->GetFieldID(_event_c, "y", "F")));
    _event_val.radius_x = static_cast<decltype(_event_val.radius_x)>(env->GetFloatField(event, env->GetFieldID(_event_c, "radiusX", "F")));
    _event_val.radius_y = static_cast<decltype(_event_val.radius_y)>(env->GetFloatField(event, env->GetFieldID(_event_c, "radiusY", "F")));
    _event_val.rotation_angle = static_cast<decltype(_event_val.rotation_angle)>(env->GetFloatField(event, env->GetFieldID(_event_c, "rotationAngle", "F")));
    _event_val.pressure = static_cast<decltype(_event_val.pressure)>(env->GetFloatField(event, env->GetFieldID(_event_c, "pressure", "F")));
    auto _rd_type = env->GetObjectField(event, env->GetFieldID(_event_c, "type", "Lnet/kurobako/cef4j/gen/CefTouchEventType;"));
    if (_rd_type) {
        _event_val.type = static_cast<decltype(_event_val.type)>(env->GetLongField(_rd_type, env->GetFieldID(env->GetObjectClass(_rd_type), "value", "J")));
    }
    _event_val.modifiers = static_cast<decltype(_event_val.modifiers)>(env->GetIntField(event, env->GetFieldID(_event_c, "modifiers", "I")));
    auto _rd_pointer_type = env->GetObjectField(event, env->GetFieldID(_event_c, "pointerType", "Lnet/kurobako/cef4j/gen/CefPointerType;"));
    if (_rd_pointer_type) {
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), imeSetComposition0)(JNIEnv* env, jobject obj, jlong self, jstring text, jlong underlinesCount, jobjectArray underlines, jobject replacement_range, jobject selection_range) {
    ...
    auto _replacement_range_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefRange");
    _replacement_range_val.from = static_cast<decltype(_replacement_range_val.from)>(env->GetIntField(replacement_range, env->GetFieldID(_replacement_range_c, "from", "I")));
    _replacement_range_val.to = static_cast<decltype(_replacement_range_val.to)>(env->GetIntField(replacement_range, env->GetFieldID(_replacement_range_c, "to", "I")));
    cef_range_t _selection_range_val = {};
    auto _selection_range_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefRange");
    _selection_range_val.from = static_cast<decltype(_selection_range_val.from)>(env->GetIntField(selection_range, env->GetFieldID(_selection_range_c, "from", "I")));
    _selection_range_val.to = static_cast<decltype(_selection_range_val.to)>(env->GetIntField(selection_range, env->GetFieldID(_selection_range_c, "to", "I")));
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), dragTargetDragEnter0)(JNIEnv* env, jobject obj, jlong self, jobject drag_data, jobject event, jobject allowed_ops) {
    ...
    if (!s) return;
    if (!event) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "event must not be null"); return; }
    if (!allowed_ops) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "allowedOps must not be null"); return; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), dragSourceEndedAt0)(JNIEnv* env, jobject obj, jlong self, jint x, jint y, jobject op) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!op) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "op must not be null"); return; }
...
CEF4J_JNI_EXPORT(jobject, CEF4J_PEER(CefBrowserHost), getVisibleNavigationEntry0)(JNIEnv* env, jobject obj, jlong self) {
    ...
    if (!_r) return nullptr;
    auto _rCls = FindClassCached(env, "net/kurobako/cef4j/gen/CefNavigationEntry$NativePeer");
    auto _rCtor = env->GetMethodID(_rCls, "<init>", "(J)V");
    return env->NewObject(_rCls, _rCtor, reinterpret_cast<jlong>(_r));
}
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), setAccessibilityState0)(JNIEnv* env, jobject obj, jlong self, jobject accessibility_state) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!accessibility_state) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "accessibilityState must not be null"); return; }
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), setAutoResizeEnabled0)(JNIEnv* env, jobject obj, jlong self, jboolean enabled, jobject min_size, jobject max_size) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!min_size) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "minSize must not be null"); return; }
    if (!max_size) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "maxSize must not be null"); return; }
    cef_size_t _min_size_val = {};
    auto _min_size_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefSize");
    _min_size_val.width = static_cast<decltype(_min_size_val.width)>(env->GetIntField(min_size, env->GetFieldID(_min_size_c, "width", "I")));
    _min_size_val.height = static_cast<decltype(_min_size_val.height)>(env->GetIntField(min_size, env->GetFieldID(_min_size_c, "height", "I")));
    cef_size_t _max_size_val = {};
    auto _max_size_c = FindClassCached(env, "net/kurobako/cef4j/gen/CefSize");
    _max_size_val.width = static_cast<decltype(_max_size_val.width)>(env->GetIntField(max_size, env->GetFieldID(_max_size_c, "width", "I")));
    _max_size_val.height = static_cast<decltype(_max_size_val.height)>(env->GetIntField(max_size, env->GetFieldID(_max_size_c, "height", "I")));
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(CefBrowserHost), executeChromeCommand0)(JNIEnv* env, jobject obj, jlong self, jint command_id, jobject disposition) {
    auto* s = reinterpret_cast<cef_browser_host_t*>(self);
    if (!s) return;
    if (!disposition) { env->ThrowNew(FindClassCached(env, "java/lang/NullPointerException"), "disposition must not be null"); return; }
