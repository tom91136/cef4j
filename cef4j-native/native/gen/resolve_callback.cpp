...
// JNI wrapper struct for cef_resolve_callback_t
...
extern "C" JNIEXPORT jlong JNICALL Java_net_kurobako_cef4j_gen_CefResolveCallback_1N_N_1Create(JNIEnv* env, jobject obj) {
    return reinterpret_cast<jlong>(Create_JniCefResolveCallback(env, obj));
}
