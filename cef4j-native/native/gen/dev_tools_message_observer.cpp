...
// JNI wrapper struct for cef_dev_tools_message_observer_t
...
extern "C" JNIEXPORT jlong JNICALL Java_net_kurobako_cef4j_gen_CefDevToolsMessageObserver_1N_N_1Create(JNIEnv* env, jobject obj) {
    return reinterpret_cast<jlong>(Create_JniCefDevToolsMessageObserver(env, obj));
}
