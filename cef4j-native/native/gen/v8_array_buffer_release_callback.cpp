...
struct JniCefV8ArrayBufferReleaseCallback: public cef_v8_array_buffer_release_callback_t {
    ...
    JniCefV8ArrayBufferReleaseCallback(JavaVM *vm, jobject handler) : cef_v8_array_buffer_release_callback_t { }, jvm(vm) {
        javaHandler = handler;
        InitRefCount<JniCefV8ArrayBufferReleaseCallback, cef_v8_array_buffer_release_callback_t>(
                reinterpret_cast<cef_base_ref_counted_t*>(static_cast<cef_v8_array_buffer_release_callback_t*>(this)));
