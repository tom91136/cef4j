...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(views_CefTextfield), setTextColor0)(JNIEnv* env, jobject obj, jlong self, jint color) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return;
    s->set_text_color(s, color);
}

CEF4J_JNI_EXPORT(jint, CEF4J_PEER(views_CefTextfield), getTextColor0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return 0;
    return static_cast<jint>(s->get_text_color(s));
}

CEF4J_JNI_EXPORT(void, CEF4J_PEER(views_CefTextfield), setSelectionTextColor0)(JNIEnv* env, jobject obj, jlong self, jint color) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return;
    s->set_selection_text_color(s, color);
}

CEF4J_JNI_EXPORT(jint, CEF4J_PEER(views_CefTextfield), getSelectionTextColor0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return 0;
    return static_cast<jint>(s->get_selection_text_color(s));
}

CEF4J_JNI_EXPORT(void, CEF4J_PEER(views_CefTextfield), setSelectionBackgroundColor0)(JNIEnv* env, jobject obj, jlong self, jint color) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return;
    s->set_selection_background_color(s, color);
}

CEF4J_JNI_EXPORT(jint, CEF4J_PEER(views_CefTextfield), getSelectionBackgroundColor0)(JNIEnv* env, jobject obj, jlong self) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return 0;
...
CEF4J_JNI_EXPORT(void, CEF4J_PEER(views_CefTextfield), setPlaceholderTextColor0)(JNIEnv* env, jobject obj, jlong self, jint color) {
    auto* s = reinterpret_cast<cef_textfield_t*>(self);
    if (!s) return;
