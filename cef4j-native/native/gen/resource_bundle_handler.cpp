...
struct JniCefResourceBundleHandler: public cef_resource_bundle_handler_t {
    ...
    JniCefResourceBundleHandler(JavaVM *vm, jobject handler) : cef_resource_bundle_handler_t { }, jvm(vm) {
        javaHandler = handler;
        InitRefCount<JniCefResourceBundleHandler, cef_resource_bundle_handler_t>(
                reinterpret_cast<cef_base_ref_counted_t*>(static_cast<cef_resource_bundle_handler_t*>(this)));
