...
public final class WindowGetClientAreaBoundsInScreenResponse implements CefMessageView, CefMessageEncoder {
    ...
    public WindowGetClientAreaBoundsInScreenResponse(@Nonnull Rect result) {
        this.result = result;
    }
    ...
    public static final CefMessageDecoder<WindowGetClientAreaBoundsInScreenResponse> DECODER = payload -> {
