...
public final class V8AccessorSetEvent implements CefMessageView, CefMessageEncoder {
    ...
    public static final int MESSAGE_ID = 982679568;
    ...
    public V8AccessorSetEvent(@Nonnull String name, @Nonnull RemoteHandle object, @Nonnull RemoteHandle value, @Nonnull String exception) {
        this.name = name;
