...
public final class XmlReaderMoveToAttributeBylnameRequest implements CefMessageView, CefMessageEncoder {
    ...
    public static final int MESSAGE_ID = 796105329;
    ...
    public XmlReaderMoveToAttributeBylnameRequest(@Nonnull RemoteHandle self, @Nonnull String localName, @Nonnull String namespaceURI) {
        this.self = self;
