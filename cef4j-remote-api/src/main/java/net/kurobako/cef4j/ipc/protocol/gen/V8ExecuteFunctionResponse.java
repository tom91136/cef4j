...
public final class V8ExecuteFunctionResponse implements CefMessageView, CefMessageEncoder {
    ...
    public V8ExecuteFunctionResponse(int valueKind, boolean boolValue, int intValue, long doubleValue, @Nonnull String stringValue, @Nonnull String errorMessage, int valueHandle) {
    ...
    public static final CefMessageDecoder<V8ExecuteFunctionResponse> DECODER = payload -> {
        ...
        WireDecoder.requireFullyConsumed(__buf, "V8ExecuteFunctionResponse");
        return new V8ExecuteFunctionResponse(valueKind, boolValue, intValue, doubleValue, stringValue, errorMessage, valueHandle);
    };
}
