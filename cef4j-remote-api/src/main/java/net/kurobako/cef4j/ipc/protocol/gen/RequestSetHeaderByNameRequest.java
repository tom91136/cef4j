...
public final class RequestSetHeaderByNameRequest implements CefMessageView, CefMessageEncoder {
    ...
    public static final int MESSAGE_ID = 147412152;
    ...
    public RequestSetHeaderByNameRequest(@Nonnull RemoteHandle self, @Nonnull String name, @Nonnull String value, int overwrite) {
        this.self = self;
        this.name = name;
