 ...
 * helper synthesises a real {@code cef_preference_observer_t} that routes the callback back to the JVM.
 */
@FunctionalInterface
public interface CefPreferenceObserver {

    /** Mirrors the {@code on_preference_changed} callback on the CEF struct. */
