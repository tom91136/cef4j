...
public interface CefReadHandler {
    ...
    /** Mirrors the {@code seek} callback. Return {@code null} or omit override
    ...
    /** Mirrors the {@code eof} callback. Return {@code null} or omit override
      * for CEF's default behavior (treated as 0); return {@link Boolean#TRUE}/{@link Boolean#FALSE} to
      * supply the int return value the helper hands back to CEF. */
    @Nullable
    default Boolean eof() { return null; }

    /** Mirrors the {@code may_block} callback. Return {@code null} or omit override
      * for CEF's default behavior (treated as 0); return {@link Boolean#TRUE}/{@link Boolean#FALSE} to
      * supply the int return value the helper hands back to CEF. */
    @Nullable
