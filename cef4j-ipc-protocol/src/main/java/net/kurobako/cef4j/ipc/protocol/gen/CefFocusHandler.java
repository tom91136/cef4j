...
public interface CefFocusHandler {
    ...
    /** Mirrors the {@code on_take_focus} callback on the CEF struct. */
    default void onTakeFocus(net.kurobako.cef4j.ipc.session.RemoteHandle browser, int next) {}

    /** Mirrors the {@code on_set_focus} callback. Return {@code null} or omit override
    ...
    /** Mirrors the {@code on_got_focus} callback on the CEF struct. */
