...
/**
 * Pure-Java stand-in for the C++ helper, used by {@link HelperProcessTest}. Implements the bootstrap protocol (binds a
 * PAIR socket, writes {@code ENDPOINT=...} to stdout) and a tiny conversation:
 *
 * <ul>
 ...
 * </ul>
 *
 * Used by tests that verify the helper-process bootstrap and request/event roundtrip without needing a real CEF helper.
 * Exits when the peer disconnects or on SIGTERM.
 */
public final class StubHelperMain {
    ...
    public static void main(String[] args) {
        ...
        try (ZContext ctx = new ZContext()) {
            ...
            System.out.println("ENDPOINT=" + resolved);
            System.out.flush();
