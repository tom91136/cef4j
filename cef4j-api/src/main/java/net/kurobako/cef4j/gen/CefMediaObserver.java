...
/**
 * Implemented by the client to observe MediaRouter events and registered via {@link net.kurobako.cef4j.gen.CefMediaRouter#addObserver(CefMediaObserver)}. The methods of this class will be called on the browser process UI thread.
...
public interface CefMediaObserver extends CefClientHandler {
    ...
    /**
     * The list of available media sinks has changed or {@link net.kurobako.cef4j.gen.CefMediaRouter#notifyCurrentSinks()} was called.
     * <p>Definition generated from cef_media_router_capi.h
     * <pre>void (CEF_CALLBACK* on_sinks)(struct _cef_media_observer_t* self, size_t sinksCount, struct _cef_media_sink_t* const* sinks);</pre>
     *
    ...
    /**
     * The list of available media routes has changed or {@link net.kurobako.cef4j.gen.CefMediaRouter#notifyCurrentRoutes()} was called.
     * <p>Definition generated from cef_media_router_capi.h
     * <pre>void (CEF_CALLBACK* on_routes)(struct _cef_media_observer_t* self, size_t routesCount, struct _cef_media_route_t* const* routes);</pre>
     *
     ...
     * <p>Definition generated from cef_media_router_capi.h
     * <pre>void (CEF_CALLBACK* on_route_state_changed)(struct _cef_media_observer_t* self, struct _cef_media_route_t* route, cef_media_route_connection_state_t state);</pre>
     *
