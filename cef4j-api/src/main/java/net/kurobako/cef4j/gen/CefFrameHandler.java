 ...
 *
 * <ul>
 *   <li>CefFremeHadler.onFrameDestroyed() => An existing main frame or sub-frame
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>CefFreameHandler.onFrameDestroyed() => Any sub-frame objects have been
 * </ul>
 *
 * destroyed.
 *
 ...
 * object. Commands can no longer be routed and will be discarded.
 *
 * <ul>
 *   <li>CefFreameHandler.onFrameDestroyed() => The main frame object has been
 * </ul>
 *
 * destroyed.
 *
 ...
 * sub-frames, and cross-origin loading on creation of new popup browsers. A temporary frame will first be created in
 * the parent frame's renderer process. This temporary frame will never attach and will be discarded after the real
 * cross-origin frame is created in the new/target renderer process. The client will receive creation callbacks for the
 * temporary frame, followed by cross-origin navigation callbacks (2) for the transition from the temporary frame to the
 * real frame. The temporary frame will not receive or execute commands during this transitional period (any sent
...
public interface CefFrameHandler extends CefClientHandler {
    ...
    /**
     * Called when a new frame is created. This will be the first notification that references {@code frame}. Any
     * commands that require transport to the associated renderer process (LoadRequest, SendProcessMessage, GetSource,
     * etc.) will be queued. The queued commands will be sent before OnFrameAttached or discarded before
     * OnFrameDestroyed if the frame never attaches.
     *
     * <p>Definition generated from cef_frame_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__frame__handler_8h.html">cef_frame_handler.h:117</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__frame__handler_8h.html">cef_frame_handler.h:129</a>
     */
     ...
     * be {@code true} if the frame was re-attached after exiting the BackForwardCache or after encountering a
     * recoverable connection error. Any queued commands will now have been dispatched. This method will not be called
     * for temporary frames created during cross-origin navigation.
     *
     * <p>Definition generated from cef_frame_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__frame__handler_8h.html">cef_frame_handler.h:141</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__frame__handler_8h.html">cef_frame_handler.h:154</a>
     */
     ...
     * {@code old_frame} will be {@code null} and {@code new_frame} will be non-{@code null} when a main frame is
     * assigned to {@code browser} for the first time. {@code old_frame} will be non-{@code null} and {@code new_frame}
     * will be {@code null} when a main frame is removed from {@code browser} for the last time. Both {@code old_frame}
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__frame__handler_8h.html">cef_frame_handler.h:171</a>
     */
