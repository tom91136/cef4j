...
public interface CefImage extends CefLibraryObject {
     ...
     * {@code pixel_data_size} parameter is derived from the buffer's capacity.</b>
     *
     * <p>Definition generated from cef_image_capi.h
     *
     * <pre>
     ...
     *
     * <p><b>The C API {@code void*} buffer parameter has been converted to {@link java.nio.ByteBuffer}; the hidden
     * {@code png_data_size} parameter is derived from the buffer's capacity.</b>
     *
     * <p>Definition generated from cef_image_capi.h
     *
     * <pre>
     ...
     *
     * <p><b>The C API {@code void*} buffer parameter has been converted to {@link java.nio.ByteBuffer}; the hidden
     * {@code jpeg_data_size} parameter is derived from the buffer's capacity.</b>
     *
     * <p>Definition generated from cef_image_capi.h
     *
     * <pre>
    ...
    final class NativePeer implements CefImage, AutoCloseable {
        ...
        static native boolean addBitmap0(
                long self,
                float scaleFactor,
                int pixelWidth,
                int pixelHeight,
        ...
        static native boolean getRepresentationInfo0(
                long self, float scaleFactor, float[] actualScaleFactor, int[] pixelWidth, int[] pixelHeight);

        static native CefBinaryValue getAsBitmap0(
                long self,
                float scaleFactor,
                @Nonnull CefColorType colorType,
                @Nonnull CefAlphaType alphaType,
