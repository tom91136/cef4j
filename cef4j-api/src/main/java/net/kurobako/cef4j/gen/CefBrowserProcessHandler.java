 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:48</a>
 */
...
public interface CefBrowserProcessHandler extends CefClientHandler {
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:56</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:82</a>
     */
     ...
     * modify the child process command line. Do not keep a reference to {@code command_line} outside of this method.
     *
     * <p>Definition generated from cef_browser_process_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:89</a>
     */
     ...
     * {@code command_line} will be read-only. Do not keep a reference to {@code command_line} outside of this method.
     * Return {@code true} if the relaunch is handled or {@code false} for default relaunch behavior. Default behavior
     * will create a new default styled Chrome window.
     *
     * <p>To avoid cache corruption only a single app instance is allowed to run for a given CefSettings.root_cache_path
     * value. On relaunch the app checks a process singleton lock and then forwards the new launch arguments to the
     * already running app process before exiting early. Client apps should therefore check the CefInitialize() return
     * value for early exit before proceeding.
     *
     * <p>This method will be called on the browser process UI thread.
     *
     * <p>Definition generated from cef_browser_process_handler_capi.h
     *
     * <pre>
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:100</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:125</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__browser__process__handler_8h.html">cef_browser_process_handler.h:141</a>
     */
    ...
    class Delegating implements CefBrowserProcessHandler {
        ...
        @Override
        public void onRegisterCustomPreferences(
                @Nonnull CefPreferencesType type, @Nullable CefPreferenceRegistrar registrar) {
        ...
        public Optional<CefClient> getDefaultClient() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefClient.Delegating(collected));
        }
        ...
        public Optional<CefRequestContextHandler> getDefaultRequestContextHandler() {
            ...
            for (CefBrowserProcessHandler d : delegates)
                d.getDefaultRequestContextHandler().ifPresent(collected::add);
