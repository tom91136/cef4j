 ...
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__permission__handler_8h.html">cef_permission_handler.h:44</a>
 */
...
public interface CefMediaAccessCallback extends CefLibraryObject {
    ...
    /**
     * Call to allow or deny media access. If this callback was initiated in response to a getUserMedia (indicated by {@link net.kurobako.cef4j.gen.CefMediaAccessPermissionTypes.Kind#DEVICE_AUDIO_CAPTURE} and/or {@link net.kurobako.cef4j.gen.CefMediaAccessPermissionTypes.Kind#DEVICE_VIDEO_CAPTURE} being set) then {@code allowed_permissions} must match {@code required_permissions} passed to OnRequestMediaAccessPermission.
     * <p>Definition generated from cef_permission_handler_capi.h
    ...
    final class NativePeer implements CefMediaAccessCallback, AutoCloseable {
      ...
      public void cancel() {
        ...
        static native void cont0(long self, int allowedPermissions);
