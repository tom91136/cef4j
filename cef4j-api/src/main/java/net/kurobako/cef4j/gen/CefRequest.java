...
public interface CefRequest extends CefLibraryObject {
     ...
     * <p>Definition generated from cef_request_capi.h
     * <pre>void (CEF_CALLBACK* set_referrer)(struct _cef_request_t* self, const cef_string_t* referrer_url, cef_referrer_policy_t policy);</pre>
     *
     ...
     * <p>Definition generated from cef_request_capi.h
     * <pre>void (CEF_CALLBACK* set_header_by_name)(struct _cef_request_t* self, const cef_string_t* name, const cef_string_t* value, int overwrite);</pre>
     *
     ...
     * <p>Definition generated from cef_request_capi.h
     * <pre>void (CEF_CALLBACK* set)(struct _cef_request_t* self, const cef_string_t* url, const cef_string_t* method, struct _cef_post_data_t* postData, cef_string_multimap_t headerMap);</pre>
     *
     ...
     * <p>Definition generated from cef_request_capi.h
     * <pre>void (CEF_CALLBACK* set_first_party_for_cookies)(struct _cef_request_t* self, const cef_string_t* url);</pre>
     *
    ...
    final class NativePeer implements CefRequest, AutoCloseable {
      ...
      public void setHeaderByName(@Nullable String name, @Nullable String value, boolean overwrite) {
        ...
        @Override
      public void set(@Nullable String url, @Nullable String method, @Nullable CefPostData postData, @Nonnull Map<String, List<String>> headerMap) {
          checkNotClosed();
            CefLibraryObject.requireOpen(postData, "CefPostData");
      ...
      public long getIdentifier() {
        ...
        static native CefReferrerPolicy getReferrerPolicy0(long self);
        ...
        static native void setFlags0(long self, int flags);
        ...
        static native long getIdentifier0(long self);
