 ...
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__textfield__delegate_8h.html">views/cef_textfield_delegate.h:45</a>
 */
...
public interface CefTextfieldDelegate extends CefClientHandler {
    ...
    /**
     * Called when {@code textfield} receives a keyboard event. {@code event} contains information about the keyboard event. Return {@code true} if the keyboard event was handled or {@code false} otherwise for default handling.
     * <p>Definition generated from views/cef_textfield_delegate_capi.h
     * <pre>int (CEF_CALLBACK* on_key_event)(struct _cef_textfield_delegate_t* self, struct _cef_textfield_t* textfield, const cef_key_event_t* event);</pre>
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__textfield__delegate_8h.html">views/cef_textfield_delegate.h:53</a>
     */
     ...
     * <p>Definition generated from views/cef_textfield_delegate_capi.h
     * <pre>void (CEF_CALLBACK* on_after_user_action)(struct _cef_textfield_delegate_t* self, struct _cef_textfield_t* textfield);</pre>
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__textfield__delegate_8h.html">views/cef_textfield_delegate.h:64</a>
     */
