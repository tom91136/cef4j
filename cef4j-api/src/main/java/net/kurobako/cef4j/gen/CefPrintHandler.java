...
public interface CefPrintHandler extends CefClientHandler {
    ...
    /**
     * Called when printing has started for the specified {@code browser}. This method will be called before the other OnPrint*() methods and irrespective of how printing was initiated (e.g. {@link net.kurobako.cef4j.gen.CefBrowserHost#print()}, JavaScript window.print() or PDF extension print button).
     * <p>Definition generated from cef_print_handler_capi.h
    ...
    /**
     * Return the PDF paper size in device units. Used in combination with {@link net.kurobako.cef4j.gen.CefBrowserHost#printToPdf(String, CefPdfPrintSettings, CefPdfPrintCallback)}.
     * <p>Definition generated from cef_print_handler_capi.h
