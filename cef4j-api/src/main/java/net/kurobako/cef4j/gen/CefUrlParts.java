...
public final class CefUrlParts {
    ...
    public static final class Mutable {
        ...
        /**
         * Host component. This may be a hostname, an IPv4 address or an IPv6 literal surrounded by square brackets
         * (e.g., "[2001:db8::1]").
         */
        ...
        /**
         * Origin contains just the scheme, host, and port from a URL. Equivalent to clearing any username and password,
         * replacing the path with a slash, and clearing everything after that. This value will be empty for
         * non-standard URLs.
         */
        ...
        @Override
        public String toString() {
            return "CefUrlParts.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "spec="
                    + spec + ", " + "scheme=" + scheme + ", " + "username=" + username + ", " + "password=" + password
                    + ", " + "host=" + host + ", " + "port=" + port + ", " + "origin=" + origin + ", " + "path=" + path
