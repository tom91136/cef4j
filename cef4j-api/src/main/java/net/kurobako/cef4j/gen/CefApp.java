...
public interface CefApp extends CefClientHandler {
    ...
    /**
     * Return the handler for resource bundle events. If no handler is returned resources will be loaded from pack
     * files. This method is called by the browser and render processes on multiple threads.
     *
     * <p>Definition generated from cef_app_capi.h
     *
    ...
    /**
     * Return the handler for functionality specific to the render process. This method is called on the render process
     * main thread.
     *
     * <p>Definition generated from cef_app_capi.h
     *
