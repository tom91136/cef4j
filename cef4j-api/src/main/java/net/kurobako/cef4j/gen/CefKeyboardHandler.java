 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__keyboard__handler_8h.html">cef_keyboard_handler.h:44</a>
 */
...
public interface CefKeyboardHandler extends CefClientHandler {
    ...
    /**
     * Called before a keyboard event is sent to the renderer. {@code event} contains information about the keyboard
     * event. {@code os_event} is the operating system event message, if any. Return {@code true} if the event was
     * handled or {@code false} otherwise. If the event will be handled in OnKeyEvent() as a keyboard shortcut set
     * {@code is_keyboard_shortcut} to {@code true} and return {@code false}.
     *
     * <p>Definition generated from cef_keyboard_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__keyboard__handler_8h.html">cef_keyboard_handler.h:51</a>
     */
    ...
    /**
     * Called after the renderer and JavaScript in the page has had a chance to handle the event. {@code event} contains
     * information about the keyboard event. {@code os_event} is the operating system event message, if any. Return
     * {@code true} if the keyboard event was handled or {@code false} otherwise.
     *
     * <p>Definition generated from cef_keyboard_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__keyboard__handler_8h.html">cef_keyboard_handler.h:66</a>
     */
