...
/**
 * Callback interface for {@link net.kurobako.cef4j.gen.CefBrowserHost#printToPdf(String, CefPdfPrintSettings, CefPdfPrintCallback)}. The methods of this class will be called on the browser process UI thread.
...
public interface CefPdfPrintCallback extends CefClientHandler {
     ...
     * <p>Definition generated from cef_browser_capi.h
     * <pre>void (CEF_CALLBACK* on_pdf_print_finished)(struct _cef_pdf_print_callback_t* self, const cef_string_t* path, int ok);</pre>
     *
