...
public interface CefAudioHandler extends CefClientHandler {
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__audio__handler_8h.html">cef_audio_handler.h:52</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__audio__handler_8h.html">cef_audio_handler.h:64</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__audio__handler_8h.html">cef_audio_handler.h:76</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__audio__handler_8h.html">cef_audio_handler.h:92</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__audio__handler_8h.html">cef_audio_handler.h:100</a>
     */
    ...
    class Delegating implements CefAudioHandler {
        ...
        public void onAudioStreamStarted(
                @Nullable CefBrowser browser, @Nonnull CefAudioParameters params, int channels) {
            for (CefAudioHandler d : delegates) d.onAudioStreamStarted(browser, params, channels);
        }

        @Override
        public void onAudioStreamPacket(
                @Nullable CefBrowser browser, @Nullable NativePointer data, int frames, long pts) {
