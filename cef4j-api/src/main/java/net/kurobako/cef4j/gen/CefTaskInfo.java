...
public final class CefTaskInfo {
    ...
    public static final class Mutable {
        ...
        /**
         * The CPU usage of the process on which the task is running. The value is in the range zero to
        ...
        /**
         * Set to {@code true} (1) if this task process' GPU resource count is inflated because it is counting other
         * processes' resources (e.g, the GPU process has this value set to {@code true} because it is the aggregate of
         * all processes).
         */
        ...
        @Override
        public String toString() {
            return "CefTaskInfo.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "id=" + id
                    + ", " + "type=" + type + ", " + "isKillable=" + isKillable + ", " + "title=" + title + ", "
                    + "cpuUsage=" + cpuUsage + ", " + "numberOfProcessors=" + numberOfProcessors + ", " + "memory="
                    + memory + ", " + "gpuMemory=" + gpuMemory + ", " + "isGpuMemoryInflated=" + isGpuMemoryInflated
                    + "}";
        }
    }
}
