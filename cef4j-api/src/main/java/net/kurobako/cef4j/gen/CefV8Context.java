 ...
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__v8_8h.html">cef_v8.h:119</a>
 */
...
public interface CefV8Context extends CefLibraryObject {
    ...
    /**
     * Execute a string of JavaScript code in this V8 context. The {@code script_url} parameter is the URL where the script in question can be found, if any. The {@code start_line} parameter is the base line number to use for error reporting. On success {@code retval} will be set to the return value, if any, and the function will return {@code true}. On failure {@code exception} will be set to the exception, if any, and the function will return {@code false}.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>int (CEF_CALLBACK* eval)(struct _cef_v8_context_t* self, const cef_string_t* code, const cef_string_t* script_url, int start_line, struct _cef_v8_value_t** retval, struct _cef_v8_exception_t** exception);</pre>
     *
     * @param scriptUrl may be null
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__v8_8h.html">cef_v8.h:208</a>
     */
    boolean eval(@Nullable String code, @Nullable String scriptUrl, int startLine, @Nullable AtomicReference<CefV8Value> retval, @Nullable AtomicReference<CefV8Exception> exception);
    /**
     * Returns the current (top) context object in the V8 context stack.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>CEF_EXPORT cef_v8_context_t* cef_v8_context_get_current_context(void);</pre>
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__v8_8h.html">cef_v8.h:129</a>
     */
     ...
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__v8_8h.html">cef_v8.h:135</a>
     */
     ...
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/150.0/cef__v8_8h.html">cef_v8.h:141</a>
     */
    ...
    final class NativePeer implements CefV8Context, AutoCloseable {
      ...
      public boolean isSame(@Nullable CefV8Context that) {
        ...
        @Override
      public boolean eval(@Nullable String code, @Nullable String scriptUrl, int startLine, @Nullable AtomicReference<CefV8Value> retval, @Nullable AtomicReference<CefV8Exception> exception) {
          checkNotClosed();
        ...
        static native CefFrame getFrame0(long self);

        static native CefV8Value getGlobal0(long self);

        static native boolean enter0(long self);
