...
public final class CefPdfPrintSettings {
    ...
    /**
     * The percentage to scale the PDF by before printing (e.g. .5 is 50%). If this value is less than or equal to zero
     * the default value of 1.0 will be used.
     */
    public final double scale;
    /**
     * Output paper size in inches. If either of these values is less than or equal to zero then the default paper size
     * (letter, 8.5 x 11 inches) will be used.
     */
    public final double paperWidth;

    public final double paperHeight;
    /**
     * Set to {@code true} (1) to prefer page size as defined by css. Defaults to {@code false} (0), in which case the
    ...
    /**
     * Paper ranges to print, one based, e.g., '1-5, 8, 11-13'. Pages are printed in the document order, not in the
     * order specified, and no more than once. Defaults to empty string, which implies the entire document is printed.
     * The page numbers are quietly capped to actual page count of the document, and ranges beyond the end of the
     * document are ignored. If this results in no pages to print, an error is reported. It is an error to specify a
     * range with start greater than end.
     */
    public final @Nullable String pageRanges;
    /**
     * Set to {@code true} (1) to display the header and/or footer. Modify {@code header_template} and/or
     * {@code footer_template} to customize the display.
     */
    public final int displayHeaderFooter;
    /**
     * HTML template for the print header. Only displayed if {@code display_header_footer} is {@code true} (1). Should
     * be valid HTML markup with the following classes used to inject printing values into them: - date: formatted print
     * date - title: document title - url: document location - pageNumber: current page number - totalPages: total pages
     * in the document For example, "&lt;span class=title&gt;&lt;/span&gt;" would generate a span containing the title.
     */
    public final @Nullable String headerTemplate;
    /**
     * HTML template for the print footer. Only displayed if {@code display_header_footer} is {@code true} (1). Uses the
     * same format as {@code header_template}.
     */
    ...
    public CefPdfPrintSettings(
            ...
            @Nullable CefPdfPrintMarginType marginType,
            double marginTop,
            double marginRight,
            double marginBottom,
            double marginLeft,
            @Nullable String pageRanges,
            int displayHeaderFooter,
            @Nullable String headerTemplate,
            @Nullable String footerTemplate,
    ...
    /**
     * Mutable variant of {@link CefPdfPrintSettings}. Structure representing PDF print settings. These values match the
     * parameters supported by the DevTools Page.printToPDF function. See <a
     * href="https://chromedevtools.github.io/devtools-protocol/tot/Page/#method-printToPDF">https://chromedevtools.github.io/devtools-protocol/tot/Page/#method-printToPDF</a>
     *
     * <p>Definition generated from internal/cef_types.h
     *
    ...
    public static final class Mutable {
        ...
        /**
         * The percentage to scale the PDF by before printing (e.g. .5 is 50%). If this value is less than or equal to
         * zero the default value of 1.0 will be used.
         */
        public double scale;
        /**
         * Output paper size in inches. If either of these values is less than or equal to zero then the default paper
         * size (letter, 8.5 x 11 inches) will be used.
         */
        public double paperWidth;

        public double paperHeight;
        /**
         * Set to {@code true} (1) to prefer page size as defined by css. Defaults to {@code false} (0), in which case
        ...
        /**
         * Paper ranges to print, one based, e.g., '1-5, 8, 11-13'. Pages are printed in the document order, not in the
         * order specified, and no more than once. Defaults to empty string, which implies the entire document is
         * printed. The page numbers are quietly capped to actual page count of the document, and ranges beyond the end
         * of the document are ignored. If this results in no pages to print, an error is reported. It is an error to
        ...
        /**
         * HTML template for the print header. Only displayed if {@code display_header_footer} is {@code true} (1).
         * Should be valid HTML markup with the following classes used to inject printing values into them: - date:
         * formatted print date - title: document title - url: document location - pageNumber: current page number -
         * totalPages: total pages in the document For example, "&lt;span class=title&gt;&lt;/span&gt;" would generate a
         * span containing the title.
         */
        public @Nullable String headerTemplate;
        /**
         * HTML template for the print footer. Only displayed if {@code display_header_footer} is {@code true} (1). Uses
         * the same format as {@code header_template}.
         */
        ...
        @Override
        public String toString() {
            return "CefPdfPrintSettings.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", "
                    + "landscape=" + landscape + ", " + "printBackground=" + printBackground + ", " + "scale=" + scale
                    + ", " + "paperWidth=" + paperWidth + ", " + "paperHeight=" + paperHeight + ", "
                    + "preferCssPageSize=" + preferCssPageSize + ", " + "marginType=" + marginType + ", " + "marginTop="
                    + marginTop + ", " + "marginRight=" + marginRight + ", " + "marginBottom=" + marginBottom + ", "
                    + "marginLeft=" + marginLeft + ", " + "pageRanges=" + pageRanges + ", " + "displayHeaderFooter="
                    + displayHeaderFooter + ", " + "headerTemplate=" + headerTemplate + ", " + "footerTemplate="
                    + footerTemplate + ", " + "generateTaggedPdf=" + generateTaggedPdf + ", "
