 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:45</a>
 */
...
public interface CefWindowDelegate extends CefClientHandler {
     ...
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>void (CEF_CALLBACK* on_window_created)(struct _cef_window_delegate_t* self, struct _cef_window_t* window);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:52</a>
     */
     ...
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>void (CEF_CALLBACK* on_window_closing)(struct _cef_window_delegate_t* self, struct _cef_window_t* window);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:58</a>
     */
    default void onWindowClosing(@Nullable CefWindow window) {}

    /**
     * Called when {@code window} is destroyed. Release all references to {@code window} and do not attempt to execute
     * any methods on {@code window} after this callback returns.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>void (CEF_CALLBACK* on_window_destroyed)(struct _cef_window_delegate_t* self, struct _cef_window_t* window);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:64</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:72</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:79</a>
     */
    default void onWindowBoundsChanged(@Nullable CefWindow window, @Nonnull CefRect newBounds) {}

    /**
     * Called when {@code window} is transitioning to or from fullscreen mode. On MacOS the transition occurs
     * asynchronously with {@code is_completed} set to {@code false} when the transition starts and {@code true} after
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:87</a>
     */
    default void onWindowFullscreenTransition(@Nullable CefWindow window, boolean isCompleted) {}

    /**
     * Return the parent for {@code window} or {@code null} if the {@code window} does not have a parent. Windows with
     * parents will not get a taskbar button. Set {@code is_menu} to {@code true} if {@code window} will be displayed as
     * a menu, in which case it will not be clipped to the parent window bounds. Set {@code can_activate_menu} to
     * {@code false} if {@code is_menu} is {@code true} and {@code window} should not be activated (given keyboard
     * focus) when displayed.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>
     * cef_window_t* (CEF_CALLBACK* get_parent_window)(struct _cef_window_delegate_t* self, struct _cef_window_t* window, int* is_menu, int* can_activate_menu);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:100</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:115</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:128</a>
     */
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:141</a>
     */
     ...
     * {@link net.kurobako.cef4j.gen.views.CefWindow#setDraggableRegions(long, CefDraggableRegion[])} to specify
     * draggable regions.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:149</a>
     */
    ...
    /**
     * Return {@code true} if {@code window} should be created with standard window buttons like close, minimize and
     * zoom. This method is only supported on macOS.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:157</a>
     */
    ...
    /**
     * Return whether the titlebar height should be overridden, and sets the height of the titlebar in
     * {@code titlebar_height}. On macOS, it can also be used to adjust the vertical position of the traffic light
     * buttons in frameless windows. The buttons will be positioned halfway down the titlebar at a height of
     * {@code titlebar_height} / 2.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:166</a>
     */
    ...
    /**
     * Return whether the view should accept the initial mouse-down event, allowing it to respond to click-through
     * behavior. If STATE_ENABLED is returned, the view will be sent a mouseDown: message for an initial mouse-down
     * event, activating the view with one click, instead of clicking first to make the window active and then clicking
     * the view.
     *
     * <p>This method is only supported on macOS. For more details, refer to the documentation of acceptsFirstMouse.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     * <pre>
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:179</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:194</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:200</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:206</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:212</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:219</a>
     */
    ...
    /**
     * Called after all other controls in the window have had a chance to handle the event. {@code event} contains
     * information about the keyboard event. Return {@code true} if the keyboard event was handled or {@code false}
     * otherwise.
     *
     * <p>Definition generated from views/cef_window_delegate_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:229</a>
     */
    ...
    /**
     * Called after the native/OS or Chrome theme for {@code window} has changed. {@code chrome_theme} will be
     * {@code true} if the notification is for a Chrome theme.
     *
     * <p>Native/OS theme colors are configured globally and do not need to be customized for each Window individually.
     * An example of a native/OS theme change that triggers this callback is when the user switches between dark and
     * light mode during application lifespan. Native/OS theme changes can be disabled by passing the
     * `--force-dark-mode` or `--force-light-mode` command-line flag.
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:240</a>
     */
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:273</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__window__delegate_8h.html">views/cef_window_delegate.h:282</a>
     */
    default boolean getLinuxWindowProperties(
            @Nullable CefWindow window, @Nonnull CefLinuxWindowProperties.Mutable properties) {
        return false;
    }
    /**
    ...
    class Delegating implements CefWindowDelegate {
        ...
        @Override
        public boolean getLinuxWindowProperties(
                @Nullable CefWindow window, @Nonnull CefLinuxWindowProperties.Mutable properties) {
            for (CefWindowDelegate d : delegates) {
