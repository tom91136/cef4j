 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__jsdialog__handler_8h.html">cef_jsdialog_handler.h:59</a>
 */
...
public interface CefJsDialogHandler extends CefClientHandler {
    ...
    /**
     * Called to run a JavaScript dialog. If {@code origin_url} is non-empty it can be passed to the
     * CefFormatUrlForSecurityDisplay function to retrieve a secure and user-friendly display string. The
     * {@code default_prompt_text} value will be specified for prompt dialogs only. Set {@code suppress_message} to
     * {@code true} and return {@code false} to suppress the message (suppressing messages is preferable to immediately
     * executing the callback as this is used to detect presumably malicious behavior like spamming alert messages in
     * onbeforeunload). Set {@code suppress_message} to {@code false} and return {@code false} to use the default
     * implementation (the default implementation will show one modal dialog at a time and suppress any additional
     * dialog requests until the displayed dialog is dismissed). Return {@code true} if the application will use a
     * custom dialog or if the callback has been executed immediately. Custom dialogs may be either modal or modeless.
     * If a custom dialog is used the application must execute {@code callback} once the custom dialog is dismissed.
     *
     * <p>Definition generated from cef_jsdialog_handler_capi.h
     *
     * <pre>
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__jsdialog__handler_8h.html">cef_jsdialog_handler.h:68</a>
     */
    ...
    /**
     * Called to run a dialog asking the user if they want to leave a page. Return {@code false} to use the default
     * dialog implementation. Return {@code true} if the application will use a custom dialog or if the callback has
     * been executed immediately. Custom dialogs may be either modal or modeless. If a custom dialog is used the
     * application must execute {@code callback} once the custom dialog is dismissed.
     *
     * <p>Definition generated from cef_jsdialog_handler_capi.h
     *
     * <pre>
     ...
     * @param messageText may be null
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__jsdialog__handler_8h.html">cef_jsdialog_handler.h:96</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__jsdialog__handler_8h.html">cef_jsdialog_handler.h:112</a>
     */
     ...
     * <p>Definition generated from cef_jsdialog_handler_capi.h
     *
     * <pre>void (CEF_CALLBACK* on_dialog_closed)(struct _cef_jsdialog_handler_t* self, struct _cef_browser_t* browser);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__jsdialog__handler_8h.html">cef_jsdialog_handler.h:120</a>
     */
    ...
    class Delegating implements CefJsDialogHandler {
        ...
        public boolean onJsDialog(
            ...
            for (CefJsDialogHandler d : delegates) {
                if (d.onJsDialog(
                        browser, originUrl, dialogType, messageText, defaultPromptText, callback, suppressMessage))
                    return true;
            }
