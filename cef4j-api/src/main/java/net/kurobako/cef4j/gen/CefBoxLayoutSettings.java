 ...
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__types_8h.html">internal/cef_types.h:3117</a>
 */
...
public final class CefBoxLayoutSettings {
    ...
    public Mutable toMutable() {
        return new Mutable(this.horizontal, this.insideBorderHorizontalSpacing, this.insideBorderVerticalSpacing, this.insideBorderInsets, this.betweenChildSpacing, this.mainAxisAlignment, this.crossAxisAlignment, this.minimumCrossAxisSize, this.defaultFlex);
    }
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(horizontal, insideBorderHorizontalSpacing, insideBorderVerticalSpacing, insideBorderInsets, betweenChildSpacing, mainAxisAlignment, crossAxisAlignment, minimumCrossAxisSize, defaultFlex);
    }

    @Override
    public String toString() {
        return "CefBoxLayoutSettings{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "horizontal=" + horizontal + ", " + "insideBorderHorizontalSpacing=" + insideBorderHorizontalSpacing + ", " + "insideBorderVerticalSpacing=" + insideBorderVerticalSpacing + ", " + "insideBorderInsets=" + insideBorderInsets + ", " + "betweenChildSpacing=" + betweenChildSpacing + ", " + "mainAxisAlignment=" + mainAxisAlignment + ", " + "crossAxisAlignment=" + crossAxisAlignment + ", " + "minimumCrossAxisSize=" + minimumCrossAxisSize + ", " + "defaultFlex=" + defaultFlex + "}";
    }
    ...
    private volatile long size = -1;
        ...
        public CefBoxLayoutSettings toImmutable() {
            return new CefBoxLayoutSettings(this.horizontal, this.insideBorderHorizontalSpacing, this.insideBorderVerticalSpacing, this.insideBorderInsets, this.betweenChildSpacing, this.mainAxisAlignment, this.crossAxisAlignment, this.minimumCrossAxisSize, this.defaultFlex);
        }
        ...
        @Override
        public String toString() {
            return "CefBoxLayoutSettings.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "horizontal=" + horizontal + ", " + "insideBorderHorizontalSpacing=" + insideBorderHorizontalSpacing + ", " + "insideBorderVerticalSpacing=" + insideBorderVerticalSpacing + ", " + "insideBorderInsets=" + insideBorderInsets + ", " + "betweenChildSpacing=" + betweenChildSpacing + ", " + "mainAxisAlignment=" + mainAxisAlignment + ", " + "crossAxisAlignment=" + crossAxisAlignment + ", " + "minimumCrossAxisSize=" + minimumCrossAxisSize + ", " + "defaultFlex=" + defaultFlex + "}";
        }
    }
}
