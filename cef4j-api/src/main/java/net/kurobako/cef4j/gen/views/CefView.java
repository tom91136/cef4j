...
public interface CefView extends CefLibraryObject {
    ...
    final class NativePeer implements CefView, AutoCloseable {
        ...
        private static native CefBrowserView asBrowserView0(long self);

        private static native CefButton asButton0(long self);

        private static native CefPanel asPanel0(long self);

        private static native CefScrollView asScrollView0(long self);

        private static native CefTextfield asTextfield0(long self);

        private static native String getTypeString0(long self);

        private static native String cefToString0(long self, boolean includeChildren);

        private static native boolean isValid0(long self);

        private static native boolean isAttached0(long self);

        private static native boolean isSame0(long self, CefView that);

        private static native CefViewDelegate getDelegate0(long self);

        private static native CefWindow getWindow0(long self);

        private static native int getId0(long self);

        private static native void setId0(long self, int id);

        private static native int getGroupId0(long self);

        private static native void setGroupId0(long self, int groupId);

        private static native CefView getParentView0(long self);

        private static native CefView getViewForId0(long self, int id);
        ...
        private static native CefSize getPreferredSize0(long self);

        private static native void sizeToPreferredSize0(long self);

        private static native CefSize getMinimumSize0(long self);

        private static native CefSize getMaximumSize0(long self);

        private static native int getHeightForWidth0(long self, int width);

        private static native void invalidateLayout0(long self);
        ...
        private static native void setEnabled0(long self, boolean enabled);

        private static native boolean isEnabled0(long self);

        private static native void setFocusable0(long self, boolean focusable);

        private static native boolean isFocusable0(long self);

        private static native boolean isAccessibilityFocusable0(long self);

        private static native boolean hasFocus0(long self);

        private static native void requestFocus0(long self);

        private static native void setBackgroundColor0(long self, int color);

        private static native int getBackgroundColor0(long self);

        private static native int getThemeColor0(long self, int colorId);

        private static native boolean convertPointToScreen0(long self, CefPoint.Mutable point);

        private static native boolean convertPointFromScreen0(long self, CefPoint.Mutable point);

        private static native boolean convertPointToWindow0(long self, CefPoint.Mutable point);

        private static native boolean convertPointFromWindow0(long self, CefPoint.Mutable point);

        private static native boolean convertPointToView0(long self, CefView view, CefPoint.Mutable point);

        private static native boolean convertPointFromView0(long self, CefView view, CefPoint.Mutable point);
