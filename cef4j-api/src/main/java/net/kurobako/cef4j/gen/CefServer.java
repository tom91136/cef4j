...
public interface CefServer extends CefLibraryObject {
     ...
     * {@code data_size} parameter is derived from the buffer's capacity.</b>
     *
     * <p>Definition generated from cef_server_capi.h
     *
     * <pre>
    ...
    final class NativePeer implements CefServer, AutoCloseable {
        ...
        static native void sendHttp200Response0(
                long self, int connectionId, @Nullable String contentType, @Nonnull ByteBuffer data);
        ...
        static native void sendHttpResponse0(
                long self,
                int connectionId,
                int responseCode,
                @Nullable String contentType,
