...
public interface CefCookieManager extends CefLibraryObject {
    ...
    final class NativePeer implements CefCookieManager, AutoCloseable {
        ...
        static native boolean visitUrlCookies0(
                long self, @Nullable String url, boolean includeHttpOnly, @Nullable CefCookieVisitor visitor);

        static native boolean setCookie0(
                long self, @Nullable String url, @Nonnull CefCookie cookie, @Nullable CefSetCookieCallback callback);

        static native boolean deleteCookies0(
                long self,
                @Nullable String url,
                @Nullable String cookieName,
                @Nullable CefDeleteCookiesCallback callback);
