...
public interface CefCookieManager extends CefLibraryObject {
    ...
    /**
     * Sets a cookie given a valid URL and explicit user-provided cookie attributes. This function expects each attribute to be well-formed. It will check for disallowed characters (e.g. the ';' character is disallowed within the cookie value attribute) and fail without setting the cookie if such characters are found. If {@code callback} is non-{@code null} it will be executed asnychronously on the UI thread after the cookie has been set. Returns {@code false} if an invalid URL is specified or if cookies cannot be accessed.
     * <p>Definition generated from cef_cookie_capi.h
     * <pre>int (CEF_CALLBACK* set_cookie)(struct _cef_cookie_manager_t* self, const cef_string_t* url, const struct _cef_cookie_t* cookie, struct _cef_set_cookie_callback_t* callback);</pre>
     *
     ...
     * <p>Definition generated from cef_cookie_capi.h
     * <pre>int (CEF_CALLBACK* delete_cookies)(struct _cef_cookie_manager_t* self, const cef_string_t* url, const cef_string_t* cookie_name, struct _cef_delete_cookies_callback_t* callback);</pre>
     *
     ...
     * <p>Definition generated from cef_cookie_capi.h
     * <pre>int (CEF_CALLBACK* flush_store)(struct _cef_cookie_manager_t* self, struct _cef_completion_callback_t* callback);</pre>
     *
     * @param callback may be null
     *
    ...
    /**
     * Returns the global cookie manager. By default data will be stored at cef_settings_t.cache_path if specified or in memory otherwise. If {@code callback} is non-{@code null} it will be executed asnychronously on the UI thread after the manager's storage has been initialized. Using this method is equivalent to calling net.kurobako.cef4j.gen.CefRequestContext.getGlobalContext()->GetDefaultCookieManager().
     * <p>Definition generated from cef_cookie_capi.h
    ...
    final class NativePeer implements CefCookieManager, AutoCloseable {
      ...
      public boolean visitAllCookies(@Nullable CefCookieVisitor visitor) {
        ...
        @Override
      public boolean visitUrlCookies(@Nullable String url, boolean includeHttpOnly, @Nullable CefCookieVisitor visitor) {
          checkNotClosed();
          return visitUrlCookies0(nativePtr, url, includeHttpOnly, visitor);
      }

        @Override
      public boolean setCookie(@Nullable String url, @Nonnull CefCookie cookie, @Nullable CefSetCookieCallback callback) {
          checkNotClosed();
          return setCookie0(nativePtr, url, cookie, callback);
      }

        @Override
      public boolean deleteCookies(@Nullable String url, @Nullable String cookieName, @Nullable CefDeleteCookiesCallback callback) {
          checkNotClosed();
