...
public final class CefWindowInfo {
    ...
    /**
     * The initial title of the window, to be set when the window is created. Some layout managers (e.g., Compiz) can
     * look at the window title in order to decide where to place the window when it is created. When this attribute is
     * not empty, the window title will be set before the window is mapped to the dispay. Otherwise the title will be
     * initially empty.
     */
    ...
    public static final class Mutable {
        ...
        /**
         * The initial title of the window, to be set when the window is created. Some layout managers (e.g., Compiz)
         * can look at the window title in order to decide where to place the window when it is created. When this
         * attribute is not empty, the window title will be set before the window is mapped to the dispay. Otherwise the
        ...
        public String toString() {
            return "CefWindowInfo.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", "
                    + "windowName=" + windowName + ", " + "bounds=" + bounds + ", " + "parentWindow=" + parentWindow
                    + ", " + "windowlessRenderingEnabled=" + windowlessRenderingEnabled + ", " + "sharedTextureEnabled="
                    + sharedTextureEnabled + ", " + "externalBeginFrameEnabled=" + externalBeginFrameEnabled + ", "
                    + "window=" + window + ", " + "runtimeStyle=" + runtimeStyle + "}";
        }
