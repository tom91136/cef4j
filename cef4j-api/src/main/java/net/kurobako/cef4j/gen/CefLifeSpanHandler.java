 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:46</a>
 */
...
public interface CefLifeSpanHandler extends CefClientHandler {
    ...
    /**
     * Called on the UI thread before a new popup browser is created. The {@code browser} and {@code frame} values
     * represent the source of the popup request (opener browser and frame). The {@code popup_id} value uniquely
     * identifies the popup in the context of the opener browser. The {@code target_url} and {@code target_frame_name}
     * values indicate where the popup browser should navigate and may be empty if not specified with the request. The
     * {@code target_disposition} value indicates where the user intended to open the popup (e.g. current tab, new tab,
     * etc). The {@code user_gesture} value will be {@code true} if the popup was opened via explicit user gesture (e.g.
     * clicking a link) or {@code false} if the popup opened automatically (e.g. via the DomContentLoaded event). The
     * {@code popupFeatures} structure contains additional information about the requested popup window. To allow
     * creation of the popup browser optionally modify {@code windowInfo}, {@code client}, {@code settings} and
     * {@code no_javascript_access} and return {@code false}. To cancel creation of the popup browser return
     * {@code true}. The {@code client} and {@code settings} values will default to the source browser's values. If the
     * {@code no_javascript_access} value is set to {@code false} the new browser will not be scriptable and may not be
     ...
     * called for the opener browser. See OnBeforePopupAborted documentation for additional details.
     *
     ...
     *   <li>Native-hosted Alloy style parent: Creates a native popup window.
     *   <li>Native-hosted Chrome style parent: Creates a Chrome UI popup window by
     * </ul>
     *
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:56</a>
     */
     ...
     * OnBeforePopup and creation fails before OnAfterCreated is called for the new popup browser. The {@code browser}
     * value is the source of the popup request (opener browser). The {@code popup_id} value uniquely identifies the
     * popup in the context of the opener browser, and is the same value that was passed to OnBeforePopup.
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:116</a>
     */
     ...
     * source of the popup request. Optionally modify {@code windowInfo}, {@code client}, {@code settings} and
     * {@code extra_info} values. The {@code client}, {@code settings} and {@code extra_info} values will default to the
     * source browser's values. Any modifications to {@code windowInfo} will be ignored if the parent browser is
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:135</a>
     */
    ...
    /**
     * Called after a new browser is created. It is now safe to begin performing actions with {@code browser}.
     * CefFrameHandler callbacks related to initial main frame creation will arrive before this callback. See
     * CefFrameHandler documentation for additional usage information.
     *
     * <p>Definition generated from cef_life_span_handler_capi.h
     *
     * <pre>
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:162</a>
     */
     ...
     *
     * <p>If the browser's top-level parent window requires a non-standard close notification then send that
     ...
     * top-level window receives the close notification and calls TryCloseBrowser(). TryCloseBrowser() returns
     * {@code true} so the client allows the window close. 9. Application's top-level window is destroyed, triggering
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:171</a>
     */
     ...
     * <p>Definition generated from cef_life_span_handler_capi.h
     *
     * <pre>void (CEF_CALLBACK* on_before_close)(struct _cef_life_span_handler_t* self, struct _cef_browser_t* browser);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__life__span__handler_8h.html">cef_life_span_handler.h:279</a>
     */
    ...
    class Delegating implements CefLifeSpanHandler {
        ...
        public boolean onBeforePopup(
            ...
            for (CefLifeSpanHandler d : delegates) {
                if (d.onBeforePopup(
                        ...
                        settings,
                        extraInfo,
                        noJavascriptAccess)) return true;
            }
        ...
        @Override
        public void onBeforeDevToolsPopup(
                @Nullable CefBrowser browser,
                @Nonnull CefWindowInfo.Mutable windowInfo,
                @Nullable AtomicReference<CefClient> client,
                @Nonnull CefBrowserSettings.Mutable settings,
                ...
                int[] useDefaultWindow) {
            for (CefLifeSpanHandler d : delegates)
                d.onBeforeDevToolsPopup(browser, windowInfo, client, settings, extraInfo, useDefaultWindow);
        }
