...
/**
 * Interface to implement to be notified of asynchronous completion via {@link net.kurobako.cef4j.gen.CefCookieManager#deleteCookies(String, String, CefDeleteCookiesCallback)}.
