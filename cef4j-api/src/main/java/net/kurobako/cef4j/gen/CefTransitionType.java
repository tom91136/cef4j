...
public final class CefTransitionType implements CefEnum<CefTransitionType> {
    ...
    public enum Kind {
         ...
         * TT_KEYWORD_GENERATED against the url '<a href="http://'">http://'</a> + keyword. For example, if you do a
         * tab-to-search against wikipedia the generated url has a transition qualifer of TT_KEYWORD, and
         * TemplateURLModel generates a visit for 'wikipedia.org' with a transition type of TT_KEYWORD_GENERATED. Chrome
         * style only.
         */
