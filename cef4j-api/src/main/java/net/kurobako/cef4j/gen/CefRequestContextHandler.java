 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__request__context__handler_8h.html">cef_request_context_handler.h:48</a>
 */
...
public interface CefRequestContextHandler extends CefClientHandler {
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__request__context__handler_8h.html">cef_request_context_handler.h:56</a>
     */
     ...
     * service workers or CefURLRequest. {@code request} represents the request contents and cannot be modified in this
     * callback. {@code is_navigation} will be {@code true} if the resource request is a navigation. {@code is_download}
     * will be {@code true} if the resource request is a download. {@code request_initiator} is the origin (scheme +
     * domain) of the page that initiated the request. Set {@code disable_default_handling} to {@code true} to disable
     * default handling of the request, in which case it will need to be handled via
     ...
     * a handler for the resource return a CefResourceRequestHandler object. This method will not be called if the
     * client associated with {@code browser} returns a non-{@code null} value from
     * {@link net.kurobako.cef4j.gen.CefRequestHandler#getResourceRequestHandler(CefBrowser, CefFrame, CefRequest,
     * boolean, boolean, String, int[])} for the same request (identified by
     * {@link net.kurobako.cef4j.gen.CefRequest#getIdentifier()}).
     *
     * <p>Definition generated from cef_request_context_handler_capi.h
     *
     * <pre>
     * cef_resource_request_handler_t* (CEF_CALLBACK* get_resource_request_handler)(struct _cef_request_context_handler_t* self, struct _cef_browser_t* browser, struct _cef_frame_t* frame, struct _cef_request_t* request, int is_navigation, int is_download, const cef_string_t* request_initiator, int* disable_default_handling);
     * </pre>
     *
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__request__context__handler_8h.html">cef_request_context_handler.h:64</a>
     */
    ...
    class Delegating implements CefRequestContextHandler {
        ...
        public Optional<CefResourceRequestHandler> getResourceRequestHandler(
            ...
            for (CefRequestContextHandler d : delegates)
