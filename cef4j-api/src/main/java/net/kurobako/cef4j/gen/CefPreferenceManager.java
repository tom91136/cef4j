...
public interface CefPreferenceManager extends CefLibraryObject {
    ...
    final class NativePeer implements CefPreferenceManager, AutoCloseable {
        ...
        static native boolean setPreference0(
                long self, @Nullable String name, @Nullable CefValue value, @Nullable String error);

        static native CefRegistration addPreferenceObserver0(
                long self, @Nullable String name, @Nullable CefPreferenceObserver observer);
