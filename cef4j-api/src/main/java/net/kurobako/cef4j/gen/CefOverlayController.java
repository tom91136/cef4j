 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:46</a>
 */
...
public interface CefOverlayController extends CefLibraryObject {
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:56</a>
     */
    boolean isValid();
     ...
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     * <pre>int (CEF_CALLBACK* is_same)(struct _cef_overlay_controller_t* self, struct _cef_overlay_controller_t* that);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:62</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:68</a>
     */
    Optional<CefView> getContentsView();

    /**
     * Returns the top-level Window hosting this overlay. Use this method instead of calling GetWindow() on the contents
     * View.
     *
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:74</a>
     */
     ...
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:81</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:87</a>
     */
    void destroy();
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:93</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:106</a>
     */
    CefRect getBounds();
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:113</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:120</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:133</a>
     */
    CefSize getSize();
     ...
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     * <pre>void (CEF_CALLBACK* set_position)(struct _cef_overlay_controller_t* self, const cef_point_t* position);
     * </pre>
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:139</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:151</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:157</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:165</a>
     */
    CefInsets getInsets();
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:171</a>
     */
    void sizeToPreferredSize();

    /**
     * Sets whether this overlay is visible. Overlays are hidden by default. If this overlay is hidden then it and any
     * child Views will not be drawn and, if any of those Views currently have focus, then focus will also be cleared.
     * Painting is scheduled as needed.
     *
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:182</a>
     */
    void setVisible(boolean visible);

    /**
     * Returns whether this overlay is visible. A View may be visible but still not drawn in a Window if any parent
     * Views are hidden. Call IsDrawn() to determine whether this overlay and all parent Views are visible and will be
     * drawn.
     *
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:191</a>
     */
    boolean isVisible();

    /**
     * Returns whether this overlay is visible and drawn in a Window. A View is drawn if it and all parent Views are
     * visible. To determine if the containing Window is visible to the user on-screen call IsVisible() on the Window.
     *
     * <p>Definition generated from views/cef_overlay_controller_capi.h
     *
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/146.0/cef__overlay__controller_8h.html">views/cef_overlay_controller.h:200</a>
     */
    boolean isDrawn();
    ...
    final class NativePeer implements CefOverlayController, AutoCloseable {
        ...
        private static native boolean isSame0(long self, CefOverlayController that);

        private static native CefView getContentsView0(long self);

        private static native CefWindow getWindow0(long self);

        private static native CefDockingMode getDockingMode0(long self);

        private static native void destroy0(long self);

        private static native void setBounds0(long self, CefRect bounds);

        private static native CefRect getBounds0(long self);

        private static native CefRect getBoundsInScreen0(long self);

        private static native void setSize0(long self, CefSize size);

        private static native CefSize getSize0(long self);

        private static native void setPosition0(long self, CefPoint position);

        private static native CefPoint getPosition0(long self);

        private static native void setInsets0(long self, CefInsets insets);

        private static native CefInsets getInsets0(long self);

        private static native void sizeToPreferredSize0(long self);

        private static native void setVisible0(long self, boolean visible);

        private static native boolean isVisible0(long self);

        private static native boolean isDrawn0(long self);
