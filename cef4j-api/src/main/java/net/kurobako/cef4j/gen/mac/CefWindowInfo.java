...
public final class CefWindowInfo implements net.kurobako.cef4j.gen.CefWindowInfo {
    ...
    /**
     * Set to {@code true} (1) to create the browser using windowless (off-screen) rendering. No view will be created
     * for the browser and all rendering will occur via the CefRenderHandler interface. The {@code parent_view} value
     * will be used to identify monitor info and to act as the parent view for dialogs, context menus, etc. If
     * {@code parent_view} is not provided then the main screen monitor will be used and some functionality that
     * requires a parent view may not function correctly. In order to create windowless browsers the
     ...
     * {@code true} or if {@code parent_view} is provided. See cef_runtime_style_t documentation for details.
     */
    ...
    public String toString() {
        return "CefWindowInfo{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "windowName="
                + windowName + ", " + "bounds=" + bounds + ", " + "hidden=" + hidden + ", " + "parentView=" + parentView
                ...
                + "view=" + view + ", " + "runtimeStyle=" + runtimeStyle + "}";
    }
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__types__mac_8h.html">internal/cef_types_mac.h:91</a>
     */
    public static final class Mutable implements net.kurobako.cef4j.gen.CefWindowInfo.Mutable {
        ...
        /**
         * Set to {@code true} (1) to create the browser using windowless (off-screen) rendering. No view will be
         * created for the browser and all rendering will occur via the CefRenderHandler interface. The
         * {@code parent_view} value will be used to identify monitor info and to act as the parent view for dialogs,
         * context menus, etc. If {@code parent_view} is not provided then the main screen monitor will be used and some
         * functionality that requires a parent view may not function correctly. In order to create windowless browsers
         * the CefSettings.windowless_rendering_enabled value must be set to {@code true}. Transparent painting is
         * enabled by default but can be disabled by setting CefBrowserSettings.background_color to an opaque value.
         */
         ...
         * is {@code true} or if {@code parent_view} is provided. See cef_runtime_style_t documentation for details.
         */
        ...
        public String toString() {
            return "CefWindowInfo.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", "
                    + "windowName=" + windowName + ", " + "bounds=" + bounds + ", " + "hidden=" + hidden + ", "
                    + "parentView=" + parentView + ", " + "windowlessRenderingEnabled=" + windowlessRenderingEnabled
                    + ", " + "sharedTextureEnabled=" + sharedTextureEnabled + ", " + "externalBeginFrameEnabled="
                    + externalBeginFrameEnabled + ", " + "view=" + view + ", " + "runtimeStyle=" + runtimeStyle + "}";
        }
    }
}
