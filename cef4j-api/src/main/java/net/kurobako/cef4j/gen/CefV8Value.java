 ...
 * } cef_v8_value_t;</pre>
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__v8_8h.html">cef_v8.h:482</a>
 */
...
public interface CefV8Value extends CefLibraryObject {
     ...
     * <p>Definition generated from cef_v8_capi.h
     * <pre>cef_v8_value_t* (CEF_CALLBACK* get_value_bykey)(struct _cef_v8_value_t* self, const cef_string_t* key);</pre>
     *
     * @param key may be null
     *
     ...
     * Associates a value with the specified identifier and returns {@code true} on success. Returns {@code false} if this method is called incorrectly or an exception is thrown. For read-only values this method will return {@code true} even though assignment failed.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>int (CEF_CALLBACK* set_value_byindex)(struct _cef_v8_value_t* self, int index, struct _cef_v8_value_t* value);</pre>
     *
     * @param index zero-based index
     *
     ...
     * <p>Definition generated from cef_v8_capi.h
     * <pre>int (CEF_CALLBACK* set_user_data)(struct _cef_v8_value_t* self, struct _cef_base_ref_counted_t* user_data);</pre>
     *
     ...
     * <p>Definition generated from cef_v8_capi.h
     * <pre>int (CEF_CALLBACK* adjust_externally_allocated_memory)(struct _cef_v8_value_t* self, int change_in_bytes);</pre>
     *
    ...
    /**
     * Execute the function using the current V8 context. This method should only be called from within the scope of a CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference. {@code object} is the receiver ('this' object) of the function. If {@code object} is empty the current context's global object will be used. {@code arguments} is the list of arguments that will be passed to the function. Returns the function return value on success. Returns {@code null} if this method is called incorrectly or an exception is thrown.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>cef_v8_value_t* (CEF_CALLBACK* execute_function)(struct _cef_v8_value_t* self, struct _cef_v8_value_t* object, size_t argumentsCount, struct _cef_v8_value_t* const* arguments);</pre>
     *
     * @param object may be null
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__v8_8h.html">cef_v8.h:979</a>
     */
    Optional<CefV8Value> executeFunction(@Nullable CefV8Value object, long argumentsCount, @Nullable CefV8Value[] arguments);

    /**
     * Execute the function using the specified V8 context. {@code object} is the receiver ('this' object) of the function. If {@code object} is empty the specified context's global object will be used. {@code arguments} is the list of arguments that will be passed to the function. Returns the function return value on success. Returns {@code null} if this method is called incorrectly or an exception is thrown.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>cef_v8_value_t* (CEF_CALLBACK* execute_function_with_context)(struct _cef_v8_value_t* self, struct _cef_v8_context_t* context, struct _cef_v8_value_t* object, size_t argumentsCount, struct _cef_v8_value_t* const* arguments);</pre>
     *
     * @param object may be null
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__v8_8h.html">cef_v8.h:994</a>
     */
    Optional<CefV8Value> executeFunctionWithContext(@Nullable CefV8Context context, @Nullable CefV8Value object, long argumentsCount, @Nullable CefV8Value[] arguments);
     ...
     * <p>Definition generated from cef_v8_capi.h
     * <pre>CEF_EXPORT cef_v8_value_t* cef_v8_value_create_object(cef_v8_accessor_t* accessor, cef_v8_interceptor_t* interceptor);</pre>
     *
    ...
    /**
     * Create a new CefV8Value object of type array with the specified {@code length}. If {@code length} is negative the returned array will have length 0. This method should only be called from within the scope of a CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference.
     * <p>Definition generated from cef_v8_capi.h
    ...
    /**
     * Create a new CefV8Value object of type ArrayBuffer which wraps the provided {@code buffer} of size {@code length} bytes. The ArrayBuffer is externalized, meaning that it does not own {@code buffer}. The caller is responsible for freeing {@code buffer} when requested via a call to {@link net.kurobako.cef4j.gen.CefV8ArrayBufferReleaseCallback#releaseBuffer(NativePointer)}. This method should only be called from within the scope of a CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference.
     * <p>
     * NOTE: Always returns {@code null} when V8 sandbox is enabled.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>CEF_EXPORT cef_v8_value_t* cef_v8_value_create_array_buffer(void* buffer, size_t length, cef_v8_array_buffer_release_callback_t* release_callback);</pre>
     *
     * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__v8_8h.html">cef_v8.h:567</a>
     */
    static Optional<CefV8Value> createArrayBuffer(@Nullable ByteBuffer buffer, @Nullable CefV8ArrayBufferReleaseCallback releaseCallback) {
      return Optional.ofNullable(NativePeer.createArrayBuffer0(buffer, releaseCallback));
  }

    /**
     * Create a new CefV8Value object of type ArrayBuffer which copies the provided {@code buffer} of size {@code length} bytes. This method should only be called from within the scope of a CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference.
     * <p>Definition generated from cef_v8_capi.h
    ...
    /**
     * Create a new CefV8Value object of type ArrayBuffer from a backing store previously created with net.kurobako.cef4j.gen.CefV8BackingStore.create(). This is a zero-copy operation  -  the ArrayBuffer uses the memory already allocated by the backing store. The backing store is consumed and becomes invalid after this call. This method should only be called from within the scope of a CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference.
     * <p>Definition generated from cef_v8_capi.h
     * <pre>CEF_EXPORT cef_v8_value_t* cef_v8_value_create_array_buffer_from_backing_store(cef_v8_backing_store_t* backing_store);</pre>
     *
     ...
     * <p>Definition generated from cef_v8_capi.h
     * <pre>CEF_EXPORT cef_v8_value_t* cef_v8_value_create_function(const cef_string_t* name, cef_v8_handler_t* handler);</pre>
     *
    ...
    /**
     * Create a new CefV8Value object of type Promise. This method should only be called from within the scope of a CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in combination with calling Enter() and Exit() on a stored CefV8Context reference.
     * <p>Definition generated from cef_v8_capi.h
    ...
    final class NativePeer implements CefV8Value, AutoCloseable {
      ...
      public Optional<CefV8Handler> getFunctionHandler() {
        ...
        @Override
      public Optional<CefV8Value> executeFunction(@Nullable CefV8Value object, long argumentsCount, @Nullable CefV8Value[] arguments) {
          checkNotClosed();
        ...
        @Override
      public Optional<CefV8Value> executeFunctionWithContext(@Nullable CefV8Context context, @Nullable CefV8Value object, long argumentsCount, @Nullable CefV8Value[] arguments) {
          checkNotClosed();
            CefLibraryObject.requireOpen(context, "CefV8Context");
            CefLibraryObject.requireOpen(object, "CefV8Value");
          return Optional.ofNullable(executeFunctionWithContext0(nativePtr, context, object, argumentsCount, arguments));
      }
