 ...
 *
 * @see <a href="https://cef-builds.spotifycdn.com/docs/146.0/cef__types__win_8h.html">internal/cef_types_win.h:71</a>
 */
...
public final class CefWindowInfo implements net.kurobako.cef4j.gen.CefWindowInfo {
    ...
    public Mutable toMutable() {
        return new Mutable(this.exStyle, this.windowName, this.style, this.bounds, this.parentWindow, this.menu, this.windowlessRenderingEnabled, this.sharedTextureEnabled, this.externalBeginFrameEnabled, this.window, this.runtimeStyle);
    }
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(exStyle, windowName, style, bounds, parentWindow, menu, windowlessRenderingEnabled, sharedTextureEnabled, externalBeginFrameEnabled, window, runtimeStyle);
    }

    @Override
    public String toString() {
        return "CefWindowInfo{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "exStyle=" + exStyle + ", " + "windowName=" + windowName + ", " + "style=" + style + ", " + "bounds=" + bounds + ", " + "parentWindow=" + parentWindow + ", " + "menu=" + menu + ", " + "windowlessRenderingEnabled=" + windowlessRenderingEnabled + ", " + "sharedTextureEnabled=" + sharedTextureEnabled + ", " + "externalBeginFrameEnabled=" + externalBeginFrameEnabled + ", " + "window=" + window + ", " + "runtimeStyle=" + runtimeStyle + "}";
    }
    ...
    private volatile long size = -1;
        ...
        public CefWindowInfo toImmutable() {
            return new CefWindowInfo(this.exStyle, this.windowName, this.style, this.bounds, this.parentWindow, this.menu, this.windowlessRenderingEnabled, this.sharedTextureEnabled, this.externalBeginFrameEnabled, this.window, this.runtimeStyle);
        }
        ...
        @Override
        public String toString() {
            return "CefWindowInfo.Mutable{" + "size=" + (size == -1 ? "pending" : Long.toString(size)) + ", " + "exStyle=" + exStyle + ", " + "windowName=" + windowName + ", " + "style=" + style + ", " + "bounds=" + bounds + ", " + "parentWindow=" + parentWindow + ", " + "menu=" + menu + ", " + "windowlessRenderingEnabled=" + windowlessRenderingEnabled + ", " + "sharedTextureEnabled=" + sharedTextureEnabled + ", " + "externalBeginFrameEnabled=" + externalBeginFrameEnabled + ", " + "window=" + window + ", " + "runtimeStyle=" + runtimeStyle + "}";
        }
    }
}
