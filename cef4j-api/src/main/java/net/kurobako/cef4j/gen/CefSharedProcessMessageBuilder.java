...
/**
 * Class that builds a CefProcessMessage containing a shared memory region. This class is not thread-safe but may be used exclusively on a different thread from the one which constructed it.
...
public interface CefSharedProcessMessageBuilder extends CefLibraryObject {
    ...
    /**
     * Creates a new CefSharedProcessMessageBuilder with the specified {@code name} and shared memory region of specified {@code byte_size}.
     * <p>Definition generated from cef_shared_process_message_builder_capi.h
    ...
    final class NativePeer implements CefSharedProcessMessageBuilder, AutoCloseable {
        ...
        private static final org.slf4j.Logger _log = org.slf4j.LoggerFactory.getLogger(CefSharedProcessMessageBuilder.class);
        ...
        private static class Release implements Runnable {
            ...
            @Override
            public void run() {
                if (_log.isTraceEnabled()) _log.trace("release CefSharedProcessMessageBuilder 0x{}", Long.toHexString(ptr));
                release0(ptr);
            }
        }
