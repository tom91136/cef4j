...
public interface CefClient extends CefClientHandler {
    ...
    class Delegating implements CefClient {
        ...
        public Optional<CefAudioHandler> getAudioHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefAudioHandler.Delegating(collected));
        }
        ...
        public Optional<CefCommandHandler> getCommandHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefCommandHandler.Delegating(collected));
        }
        ...
        public Optional<CefDialogHandler> getDialogHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefDialogHandler.Delegating(collected));
        }
        ...
        public Optional<CefDisplayHandler> getDisplayHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefDisplayHandler.Delegating(collected));
        }
        ...
        public Optional<CefDownloadHandler> getDownloadHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefDownloadHandler.Delegating(collected));
        }
        ...
        public Optional<CefDragHandler> getDragHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefDragHandler.Delegating(collected));
        }
        ...
        public Optional<CefFindHandler> getFindHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefFindHandler.Delegating(collected));
        }
        ...
        public Optional<CefFocusHandler> getFocusHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefFocusHandler.Delegating(collected));
        }
        ...
        public Optional<CefFrameHandler> getFrameHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefFrameHandler.Delegating(collected));
        }
        ...
        public Optional<CefPermissionHandler> getPermissionHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefPermissionHandler.Delegating(collected));
        }
        ...
        public Optional<CefJsDialogHandler> getJsDialogHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefJsDialogHandler.Delegating(collected));
        }
        ...
        public Optional<CefKeyboardHandler> getKeyboardHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefKeyboardHandler.Delegating(collected));
        }
        ...
        public Optional<CefLifeSpanHandler> getLifeSpanHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefLifeSpanHandler.Delegating(collected));
        }
        ...
        public Optional<CefLoadHandler> getLoadHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefLoadHandler.Delegating(collected));
        }
        ...
        public Optional<CefPrintHandler> getPrintHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefPrintHandler.Delegating(collected));
        }
        ...
        public Optional<CefRenderHandler> getRenderHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefRenderHandler.Delegating(collected));
        }
        ...
        public Optional<CefRequestHandler> getRequestHandler() {
            ...
            return collected.isEmpty() ? Optional.empty() : Optional.of(new CefRequestHandler.Delegating(collected));
        }
