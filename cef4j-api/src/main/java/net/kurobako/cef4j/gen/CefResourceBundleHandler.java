 ...
 *
 * @see <a
 *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__resource__bundle__handler_8h.html">cef_resource_bundle_handler.h:43</a>
 */
...
public interface CefResourceBundleHandler extends CefClientHandler {
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__resource__bundle__handler_8h.html">cef_resource_bundle_handler.h:53</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__resource__bundle__handler_8h.html">cef_resource_bundle_handler.h:64</a>
     */
     ...
     *
     * @see <a
     *     href="https://cef-builds.spotifycdn.com/docs/150.0/cef__resource__bundle__handler_8h.html">cef_resource_bundle_handler.h:78</a>
     */
    default boolean getDataResourceForScale(
            int resourceId,
            @Nonnull CefScaleFactor scaleFactor,
            @Nonnull AtomicReference<NativePointer> data,
            long[] dataSize) {
        return false;
    }
    /**
    ...
    class Delegating implements CefResourceBundleHandler {
        ...
        @Override
        public boolean getDataResourceForScale(
                int resourceId,
                @Nonnull CefScaleFactor scaleFactor,
                @Nonnull AtomicReference<NativePointer> data,
                long[] dataSize) {
