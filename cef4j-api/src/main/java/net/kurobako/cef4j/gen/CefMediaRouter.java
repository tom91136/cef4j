...
public interface CefMediaRouter extends CefLibraryObject {
    ...
    /**
     * Trigger an asynchronous call to {@link net.kurobako.cef4j.gen.CefMediaObserver#onSinks(long, CefMediaSink[])} on all registered observers.
     * <p>Definition generated from cef_media_router_capi.h
    ...
    /**
     * Create a new route between {@code source} and {@code sink}. Source and sink must be valid, compatible (as reported by {@link net.kurobako.cef4j.gen.CefMediaSink#isCompatibleWith(CefMediaSource)}), and a route between them must not already exist. {@code callback} will be executed on success or failure. If route creation succeeds it will also trigger an asynchronous call to {@link net.kurobako.cef4j.gen.CefMediaObserver#onRoutes(long, CefMediaRoute[])} on all registered observers.
     * <p>Definition generated from cef_media_router_capi.h
    ...
    /**
     * Trigger an asynchronous call to {@link net.kurobako.cef4j.gen.CefMediaObserver#onRoutes(long, CefMediaRoute[])} on all registered observers.
     * <p>Definition generated from cef_media_router_capi.h
    ...
    /**
     * Returns the MediaRouter object associated with the global request context. If {@code callback} is non-{@code null} it will be executed asnychronously on the UI thread after the manager's storage has been initialized. Equivalent to calling net.kurobako.cef4j.gen.CefRequestContext.getGlobalContext()->GetMediaRouter().
     * <p>Definition generated from cef_media_router_capi.h
    ...
    final class NativePeer implements CefMediaRouter, AutoCloseable {
      ...
      public void notifyCurrentSinks() {
        ...
        @Override
      public void createRoute(@Nullable CefMediaSource source, @Nullable CefMediaSink sink, @Nullable CefMediaRouteCreateCallback callback) {
          checkNotClosed();
