...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_REQUEST_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_REQUEST_REQUEST_H_
...
struct UrlrequestGetRequestRequest {
    static constexpr int32_t kMessageId = 1497955604;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_REQUEST_REQUEST_H_
