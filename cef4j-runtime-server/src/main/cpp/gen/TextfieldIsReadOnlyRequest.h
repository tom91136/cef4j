...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_IS_READ_ONLY_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_IS_READ_ONLY_REQUEST_H_
...
struct TextfieldIsReadOnlyRequest {
    static constexpr int32_t kMessageId = 2078477953;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_IS_READ_ONLY_REQUEST_H_
