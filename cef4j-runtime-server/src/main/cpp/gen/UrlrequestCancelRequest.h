...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CANCEL_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CANCEL_REQUEST_H_
...
struct UrlrequestCancelRequest {
    static constexpr int32_t kMessageId = 1732336282;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CANCEL_REQUEST_H_
