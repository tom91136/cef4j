...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_RESPONSE_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_RESPONSE_REQUEST_H_
...
struct UrlrequestGetResponseRequest {
    static constexpr int32_t kMessageId = 708919234;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_RESPONSE_REQUEST_H_
