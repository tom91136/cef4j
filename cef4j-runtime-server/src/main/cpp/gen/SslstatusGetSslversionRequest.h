...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_SSLVERSION_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_SSLVERSION_REQUEST_H_
...
struct SslstatusGetSslversionRequest {
    static constexpr int32_t kMessageId = 1741652953;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_SSLVERSION_REQUEST_H_
