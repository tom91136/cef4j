...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_VIEW_AS_TEXTFIELD_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_VIEW_AS_TEXTFIELD_REQUEST_H_
...
struct ViewAsTextfieldRequest {
    static constexpr int32_t kMessageId = 674549256;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_VIEW_AS_TEXTFIELD_REQUEST_H_
