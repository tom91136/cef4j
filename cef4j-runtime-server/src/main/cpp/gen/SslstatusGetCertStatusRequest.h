...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_CERT_STATUS_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_CERT_STATUS_REQUEST_H_
...
struct SslstatusGetCertStatusRequest {
    static constexpr int32_t kMessageId = 1121282956;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLSTATUS_GET_CERT_STATUS_REQUEST_H_
