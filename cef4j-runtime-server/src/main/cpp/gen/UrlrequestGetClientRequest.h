...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_CLIENT_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_CLIENT_REQUEST_H_
...
struct UrlrequestGetClientRequest {
    static constexpr int32_t kMessageId = 38985467;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_GET_CLIENT_REQUEST_H_
