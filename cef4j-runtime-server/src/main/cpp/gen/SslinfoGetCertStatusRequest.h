...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLINFO_GET_CERT_STATUS_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLINFO_GET_CERT_STATUS_REQUEST_H_
...
struct SslinfoGetCertStatusRequest {
    static constexpr int32_t kMessageId = 1878596707;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_SSLINFO_GET_CERT_STATUS_REQUEST_H_
