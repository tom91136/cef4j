...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_HAS_SELECTION_REQUEST_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_HAS_SELECTION_REQUEST_H_
...
struct TextfieldHasSelectionRequest {
    static constexpr int32_t kMessageId = 2115466512;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_TEXTFIELD_HAS_SELECTION_REQUEST_H_
