...
#ifndef NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CLIENT_GET_AUTH_CREDENTIALS_EVENT_H_
#define NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CLIENT_GET_AUTH_CREDENTIALS_EVENT_H_
...
struct UrlrequestClientGetAuthCredentialsEvent {
    static constexpr int32_t kMessageId = 579318505;
...
#endif // NET_KUROBAKO_CEF4J_IPC_PROTOCOL_GEN_URLREQUEST_CLIENT_GET_AUTH_CREDENTIALS_EVENT_H_
